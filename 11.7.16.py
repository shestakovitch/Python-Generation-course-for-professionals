...
Программа должна найти во введенном фрагменте HTML-страницы все гиперссылки и вывести их составляющие — адресные части и
...
for data in [line.strip() for line in sys.stdin]:
    [print(*item, sep=', ') for item in re.findall(r'.*href=\"(.+)">(.+)</a>', data)]