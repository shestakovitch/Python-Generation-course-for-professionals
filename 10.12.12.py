...
кошельке имеется множество купюр различного номинала, которые представлены в списке wallet. Например, Тимур может
расплатиться одной купюрой в 100$ или двумя по 50$.
...
counter = 0
for i in range(14):
    counter += sum(1 for cash in set(combinations(wallet, i)) if sum(cash) == 100)
print(counter)