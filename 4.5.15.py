...
with ZipFile('workbook.zip') as zip_file:
    ...
    print(f'Объем исходных файлов: {sum(info[i].file_size for i in range(len(info)))} байт(а)')
    print(f'Объем сжатых файлов: {sum(info[i].compress_size for i in range(len(info)))} байт(а)')